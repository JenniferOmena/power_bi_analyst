...
Ao instalar o conector my sql connector por algum motivo o Power BI não o reconheceu, depois de várias tentativas de reisntalação que resultaram no mesmo erro, resolvi instalar o MySQL no VSCode, após a instalação o problema foi resolvido e consegui realizar a conexão do Power BI com o banco de dados.

![image](https://github.com/JenniferOmena/power_bi_analyst/assets/81773070/4788eeea-e7ac-4e12-8dac-39be62bf748b)
...
![image](https://github.com/JenniferOmena/power_bi_analyst/assets/81773070/29222ea2-06f6-4770-bf2c-5a5bd86e8158)
